...
public class MyController {
	...
	public ResponseEntity<byte[]> downloadReport() throws JRException, IOException {
		...
		JasperReport compileReport = JasperCompileManager.compileReport(new FileInputStream("src/main/resources/CourseReport.jrxml"));
		...
		headers.add("Content-Disposition", "inline; filename=coursesreport.pdf");//forcing browser to download the pdf file
